...
from .views import InstructorDashBoardView, contactAdminView, public_profile_view, UserProfileUpdate,testing_profile
...
urlpatterns = [
    ...
    # academy profile
    path('profile/<str:username>/', testing_profile, name='profile'),
